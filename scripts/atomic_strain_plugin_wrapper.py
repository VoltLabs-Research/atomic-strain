...
BINARY_NAME = "atomic-strain"
PLUGIN_REPO_DIRNAME = "AtomicStrain"
ENV_BINARY_OVERRIDE = "VOLT_ATOMIC_STRAIN_BINARY"
REQUIRED_OUTPUTS = ["_atomic_strain.msgpack", "_atoms.msgpack"]
LOG_TAG = "atomic-strain-plugin"
